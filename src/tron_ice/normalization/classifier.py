...
def run_transaction_normalizer(
    ...
    with open(log_file, "w", encoding="utf-8") as log:
        ...
        # Normalize
        try:
            from src.tron_ice.config.settings import TOKEN_WHITELIST
            ...
            from src.tron_ice.normalization.data_normalizer import (
        ...
        try:
            ...
            from src.tron_ice.normalization.classifier import (
